...
Für den Demonstrator werden DeepL (Qualitätsführer) und Azure Translator (kosteneffizient) empfohlen.
Beide erfüllen die funktionalen, nicht-funktionalen und rechtlichen Anforderungen weitgehend.

Zusätzlich wird OPUS-MT als Open-Source-Alternative im Demonstrator integriert \parencite{reddit2022nllb}.
Obwohl die Übersetzungsqualität hinter den kommerziellen APIs zurückbleibt, ermöglicht dies einen direkten Vergleich sowie 
die Evaluation einer selbstgehosteten Lösung ohne externe API-Abhängigkeit.
